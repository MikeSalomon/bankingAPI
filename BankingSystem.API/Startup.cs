...
namespace BankingSystem.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //opt.UseSqlServer(Configuration.GetConnectionString("BankConnection")));
            services.AddDbContext<BankContext>(opt => opt.UseInMemoryDatabase("InMemoryDb")); 
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            // docker runs in production environment. Removing HTTPS redirect for simplicity. 
            if (env.IsDevelopment())
            {
